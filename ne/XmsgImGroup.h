...
#ifndef NE_XMSGIMGROUP_H_
#define NE_XMSGIMGROUP_H_

#include "XmsgNe.h"

class XmsgImGroup: public XmsgNe
{
public:
...
public:
	...
	XmsgImGroup(shared_ptr<XscTcpServer> tcpServer, const string &peer, const string& pwd, const string& alg);
	virtual ~XmsgImGroup();
};
